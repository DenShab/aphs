/* KindEditor 4.1.12 (2019-03-07), Copyright (C) kindeditor.net, Licence: http://kindeditor.net/license.php */ ! function(window, undefined) {
    function _isArray(a) {
        ...
        if (!(_IE && "br" !== d || _GECKO && 3 > _V && "p" !== d || _OPERA && 9 > _V)) {
            ...
            K(c).keydown(function(g) {
                ...
                if (!(13 != e.which || e.shiftKey || e.ctrlKey || e.altKey) && "br" != d) {
                    ...
                    b.cmd.selection();
                    var i = a(b.cmd.range);
                    "marquee" != i && "select" != i && (f[i] || _nativeCommand(c, "formatblock", "<p>"))
                }
            })
        }
    }
    ...
    function _undoToRedo(a, b) {
        ...
        return _removeBookmarkTag(d.html) === _removeBookmarkTag(h.html) && a.length > 0 && (h = a.pop()),
            f.designMode ? (f.html(h.html), h.start && (c.moveToBookmark(h), e.select())) : K(g).html(_removeBookmarkTag(h.html)), e
    }
    ...
    if (!window.KindEditor) {
        ...
        (html = document.getElementsByTagName("html")) && (_direction = html[0].dir), _extend(KEdit, KWidget, {
            init: function(a) {
                ...
                var c = this;
                KEdit.parent.init.call(c, a), c.srcElement = K(a.srcElement), c.div.addClass("ke-edit row-container"), c.designMode = _undef(a.designMode, !0), c.beforeGetHtml = a.beforeGetHtml, c.beforeSetHtml = a.beforeSetHtml, c.afterSetHtml = a.afterSetHtml;
                ...
                c.iframe = K('<iframe class="ke-edit-iframe second-row" hidefocus="true" frameborder="0"' + j + "></iframe>").css("width", "100%"), c.textarea = K('<textarea class="ke-edit-textarea" hidefocus="true"></textarea>').css("width", "100%"), c.tabIndex = isNaN(parseInt(a.tabIndex, 10)) ? c.srcElement.attr("tabindex") : parseInt(a.tabIndex, 10), c.iframe.attr("tabindex", c.tabIndex), c.textarea.attr("tabindex", c.tabIndex), c.width && c.setWidth(c.width), c.height && c.setHeight(c.height), c.designMode ? c.textarea.hide() : c.iframe.hide(), h && c.iframe.bind("load", function(a) {
